...
testNN.loadVariables("Variables/variables_AutoEncoder_preds2_300-relu-loss-decayedLR-10iters", variableName="W1", targetName=importedW1)
testNN.loadVariables("Variables/variables_AutoEncoder_preds2_300-relu-loss-decayedLR-10iters", variableName="b1", targetName=importedb1)
...
if __name__ == "__main__":
    ...
    #save parameters
    testNN.saveVariables("Variables/variables_NN_preds2_300-relu-crossEntropy-decayedLR-10iters")
