...
testNN = nn.NeuralNet(embeddingClass=w2v, vectorSize=w2v.getVectorSize(),hiddenNodes=150, outputNodes=2, trainingEpochs=10, activationFunction="tanh", costFunction="crossEntropy", learningRate=None)
...
testNN.loadVariables("Variables/variables_AutoEncoder_150-tanh-loss-decayedLR-10iters", variableName="W1", targetName=importedW1)
testNN.loadVariables("Variables/variables_AutoEncoder_150-tanh-loss-decayedLR-10iters", variableName="b1", targetName=importedb1)
...
if __name__ == "__main__":
    ...
    #save parameters
    testNN.saveVariables("Variables/variables_NN_150-tanh-crossEntropy-decayedLR-10iters")
