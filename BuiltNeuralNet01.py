...
testNN.loadVariables("Variables/variables_AutoEncoder_400-tanh-loss-decayedLR-10iters", variableName="W1", targetName=importedW1)
testNN.loadVariables("Variables/variables_AutoEncoder_400-tanh-loss-decayedLR-10iters", variableName="b1", targetName=importedb1)
...
if __name__ == "__main__":
    ...
    #save parameters
    testNN.saveVariables("Variables/variables_NN_400-tanh-crossEntropy-decayedLR-10iters")
